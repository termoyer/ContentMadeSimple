...
<body>
   <div id="container">
      ...
      <div id="wrapper">
        ...
        <div id="footer">&copy; <?php date_default_timezone_set("GMT");echo(date("Y")); ?> <?php print $p->getSiteTitle(); ?>. Powered by: <a href="http://www.norox.org/cms">ContentMadeSimple</a> Designed by <a href="http://norox.org">Norox Media-Solutions&trade;</a>.</div>
