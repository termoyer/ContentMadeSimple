...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" >
	<head>
		...
		<meta name="author" content="name of author - Norox Media-Solutions (TM) - http://norox.org" />
		...
		<div id="main">
			...
			<div id="footer">
				<p>
					...
					&copy; <?php date_default_timezone_set("GMT");echo(date("Y")); ?> <?php print $p->getSiteTitle(); ?>. Powered by: <a href="http://www.norox.org/cms">ContentMadeSimple</a> - Designed By: <a href="http://www.norox.org">Norox Media-Solutions&trade;</a>				
				</p>
			</div>
		</div>
	</body>
