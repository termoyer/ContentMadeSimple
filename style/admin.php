...
<body>
  ...
  <div id="masthead">
    <div style="float: left;"><a href="index.php?page=index"><img src="style/comps/admin/img/smalllogo.png" style="text-decoration: none; border: 0;" alt="ContentMadeSimple Adminstration"/></a></div>
    <div style="float: right;"><a href="http://www.norox.org/cms"><img src="style/comps/admin/img/version.png" style="text-decoration: none; border: 0;" alt="ContentMadeSimple Adminstration"/></a></div>
  </div>
  ...
  <div id="content">
    ...
    <ul id="footer" class="clearfix">
      ...
      <li style="float: right;">Proudly Powered by: <a href="http://www.norox.org/cms">ContentMadeSimple</a></li>
