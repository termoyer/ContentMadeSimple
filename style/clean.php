...
<body>
  ...
  <div id="content">
	...
	<p class="subheader">Visit the <a href="http://www.norox.org">Norox&trade;-Website</a> for even more!</p>
    ...
    <ul id="footer" class="clearfix">
      ...
      <li>Design: <a href="http://www.norox.org">Norox Media-Solutions&trade;</a></li>
      
      <li>&copy; <?php echo(date("Y")); ?> Norox Media-Solutions&trade;. All Rights Reserved.</li>
